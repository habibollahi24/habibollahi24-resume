...
const Cart = ({ cartData }) => {
   ...
   return (
      <div className="  bg-white dark:bg-dark-500 dark:shadow md:col-span-1 rounded-md  relative my-10 ">
         <Link
            to={`${pathname}/${cartData.slug}`}
            className="z-20 relative block transition-all scale-100 p-1 hover:scale-105"
         >
            <div className="overflow-hidden   ">
               <div className="gradiant-bg">
                  <img src={cartData.screenshot} alt={cartData.title} className=" rounded-md " />
               </div>
            </div>
         </Link>
